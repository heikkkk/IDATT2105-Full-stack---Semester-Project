...
<template>
  ...
  <div class="hamburger-menu" ref="menuRef">
    <ul>
      ...
      <li><RouterLink class="hamburger-menu-link" to="/change-language">Change Language</RouterLink></li>
      <li><RouterLink class="hamburger-menu-link" to="/help">Help</RouterLink></li>
    </ul>
  </div>
</template>